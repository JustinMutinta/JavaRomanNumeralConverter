...
public class Main {
    ...
    public static String romanValue1(int userNumber, int decidingNumber){
        ...
        if(userNumber >= 1_000_000){array1 = 0;}
        else if(userNumber >= 100_000)  {array1 = 1;}
        else if(userNumber >= 10_000)   {array1 = 2;}
        else if(userNumber >= 1000)     {array1 = 3;}
        else if(userNumber >= 100)      {array1 = 4;}
        else if(userNumber >= 10)       {array1 = 5;}
        else                            {array1 = 6;}

        int tempNum = 0;
        tempNum = userNumber/decidingNumber;
        if(tempNum == 9)        {output += romanArray[array1][0];}
        else if(tempNum == 5)   {output += romanArray[array1][1];}
        else if(tempNum == 4)   {output += romanArray[array1][2];}
        else if(tempNum == 1)   {output += romanArray[array1][3];}
